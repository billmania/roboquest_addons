...
wget -O Dockerfile.roboquest_core \
    https://github.com/billmania/roboquest/raw/refs/heads/main/ros2ws/Dockerfile.roboquest_core
...
git clone --branch 116-add-configuration-for-csi-arducam \
